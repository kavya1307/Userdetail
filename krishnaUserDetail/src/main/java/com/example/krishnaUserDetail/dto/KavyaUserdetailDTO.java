package com.example.krishnaUserDetail.dto;

public class KavyaUserdetailDTO {
	...
	public String toString() {
		return "KavyaUserdetailDTO [usertoken=" + usertoken + ", firstname=" + firstname + ", lastname=" + lastname
